...
┌──(kali㉿kali)-[~/Descargas]
└─$ ls
 capture.pcap            '_Forensics is fun.pptm.extracted'   vulture.jpg
 exp.py                   picopico.key
'Forensics is fun.pptm'   __pycache__
                                                                          
┌──(kali㉿kali)-[~/Descargas]
└─$ cd _Forensics\ is\ fun.pptm.extracted 
                                                                          
┌──(kali㉿kali)-[~/Descargas/_Forensics is fun.pptm.extracted]
└─$ ls
...
└── _rels
User
┌──(kali㉿kali)-[~/Descargas/_Forensics is fun.pptm.extracted/ppt/slideMasters]
└─$ ls
hidden  _rels  slideMaster1.xml
                                                                          
┌──(kali㉿kali)-[~/Descargas/_Forensics is fun.pptm.extracted/ppt/slideMasters]
└─$ cat hide
cat: hide: No existe el fichero o el directorio
